        ...
        <div className="col-md-6">
          ...
          <div className="filter-section mb-3 p-3 border rounded">
            ...
            <div className="d-flex flex-column">
              ...
              {/* Condition */}
              <label htmlFor="conditionSelect" className="form-label mt-2">Condition</label>
              ...
              {/* Age Slider */}
              <label htmlFor="ageRange" className="form-label mt-3">
                Age (Years): <strong>{ageRange}</strong>
              </label>
              <input
                id="ageRange"
                type="range"
